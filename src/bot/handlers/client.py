...
# Helper to get month keyboard (simplified)
...
# Helper to get date keyboard for a given month
...
# Helper to get engineer keyboard (simplified)
...
# Helper to get time keyboard (simplified)
...
# Helper to get duration keyboard
